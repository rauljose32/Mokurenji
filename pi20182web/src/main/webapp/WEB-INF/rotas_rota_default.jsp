        ...
        <article id="wrapper">
            <section id="main">
                ...
                <section id="content">
                            ...
                            <section id="section_div_menu_sup">
                                ...
                                <section>
                                    <nav id="menu_rotas_content">
                                        <ul>
                                            <a class="active" href="servletRota?acao=rotaDefault">
                                                <li>
                    ...
                    <section id="corpo">
                        <form action="servletRota?acao=addRotaDefault" method="post">
                            <label class="inputCaixa"><p>IP GATEWAY:</p>
                                <input type="text" name="ipGateway" pattern="[.0-9]+" maxlength="15" autofocus required>
                            </label>
                            <br>
                        ...
                        <section class="backTable">
                            ...
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                <c:forEach items="${rotasDefault}" var="rota">
                                    <tr>
                                        <th>${rota.id}</th>
                                        <th>${rota.gateway}</th>
                                        <th>
                                            <a href="servletRota?acao=delRotaDefault&idrotaDefault=${rota.id}" onclick="return window.confirm('Deseja excluir o registro ${rota.id} ?')">
