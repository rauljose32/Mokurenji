        ...
        <article id="wrapper">
            <section id="main">
                ...
                <section id="content">
                                ...
                                <section>
                                    <nav id="menu_rotas_content">
                                        <ul>
                                            ...
                                            <a class="active" href="servletRota?acao=rotaHost">
                                                <li>
                                                    <p><b>Rota host</b></p>
                                                </li>
                                            </a>
                                            <a href="servletRota?acao=rotaRede">
                                                <li>
                                                    <p><b>Rota rede</b></p>
                                                </li>
                                            </a>
                    ...
                    <section id="corpo">
                        <form action="servletRota?acao=addRotaHost" method="post">
                            <label class="inputCaixa"><p>IP HOST:</p>
                                <input type="text" name="ipHost" pattern="[.0-9]+" maxlength="15" autofocus required>
                            </label>
                            <br>
                        ...
                        <section class="backTable">
                            ...
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                <c:forEach items="${rotasHost}" var="host">
                                    <tr>
                                        <th>${host.id}</th>
                                        <th>${host.hostDestino}</th>
                                        <th>${host.gateway}</th>
                                        <th>
                                            <a href="servletRota?acao=delRotaHost&idrotaHost=${host.id}" onclick="return window.confirm('Deseja excluir o registro ${host.id} ?')">
